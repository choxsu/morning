...
public class JobLogController {
    ...
    @GetMapping()
    public ReturnT<Map<String, Object>> index(HttpServletRequest request, @RequestParam(required = false, defaultValue = "0") Integer jobId) {
    ...
    public ReturnT<Map<String, Object>> logDetailPage(int id) {
