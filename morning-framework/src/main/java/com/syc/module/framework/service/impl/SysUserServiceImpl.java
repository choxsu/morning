...
import com.syc.module.common.constant.UserConstants;
...
import com.syc.module.framework.api.sysconfig.ConfigExpander;
...
import com.syc.module.framework.mapper.SysUserMapper;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public void updateUserLogin(Long id, String loginIp) {
        userMapper.updateById(new SysUserEntity().setUserId(id).setLoginIp(loginIp).setLoginDate(new Date()));
    }
